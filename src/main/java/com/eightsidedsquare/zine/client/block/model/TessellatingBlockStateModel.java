...
public class TessellatingBlockStateModel implements BlockStateModel {
    ...
    public record Unbaked(Identifier parent, Identifier texture, Optional<Identifier> particleTexture, int size) implements CustomUnbakedBlockStateModel, SimpleModel {
        ...
        public Unbaked(Identifier parent, Identifier texture, Identifier particleTexture, int size) {
            this(parent, texture, Optional.of(particleTexture), size);
        }

        public Unbaked(Identifier parent, Identifier texture, int size) {
            this(parent, texture, Optional.empty(), size);
        }
        ...
        public BlockStateModel bake(Baker baker) {
            ...
            Mesh[] meshes = new Mesh[this.size * this.size * 3];
            Sprite sprite = spriteGetter.get(SpriteIds.block(this.texture), this);
            ...
            Sprite particleSprite = this.particleTexture
                    .map(id -> spriteGetter.get(SpriteIds.block(id), this))
                    .orElse(sprite);
